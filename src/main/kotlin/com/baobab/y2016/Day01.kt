...
//class Day01 : Day() {
//
//    private val data = Utils.readFile(2016, 1, "input")
//
//    private fun getEndPosition() = data.map { it.toString() }
//        .map {
//            Instruction(
...
//
//    override fun part2(): Any = getEndPosition()
//        .getDistanceFirstCrossing()
//
//}
//
//fun main() {
